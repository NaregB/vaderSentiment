...
#. You could also clone this `[GitHub repository] <https://github.com/NaregB/vaderSentiment>`_
#. You could download and unzip the `[full master branch zip file] <https://github.com/NaregB/vaderSentiment/archive/master.zip>`_
